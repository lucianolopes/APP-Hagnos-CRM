...
function deletaProdCliente(idp, idcliente,t){
    ...
    if (t == 2){
        ...
        var url2 = 'saves/deleta.php?tb=produtos_clientes&id='+idp;
        var loadUrl = 'loadProdClientes.php';
        var tbRetorno = 'tab3-a';
    }
            ...
            success: function(returnedData) {
                ...
                $$.ajax({
                    ...
                    success: function (data) {
                        ...
                        var i = 0;
                        $$(".lista-prods").find("tr").each(function(){
                            i++;
                        });
                        $$(".totalregistros-prod").html("PRODUTOS ("+(i-1)+")");
